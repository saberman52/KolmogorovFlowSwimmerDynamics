% KOLMOGOROVADIABATICDRIFTBELOW computes the integral of the noise-induced drift
...
% Assumes parameters are below phase space bifurcation
%
% Inputs:
...
% TH - TH(t)
% T - time steps
function [dPsi,DInt,Tp,Y,TH,T] = kolmogorovAdiabaticDriftBelow(y0,th0,v0,alpha)
Q0 = [y0,th0,0,0];
